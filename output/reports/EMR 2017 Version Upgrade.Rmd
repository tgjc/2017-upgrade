...
```{r install libraries and preprocess data, include=FALSE}
library(dplyr)
library(tidyr)
library(ggplot2)
library(magrittr)
...
```{r plot trend, echo=FALSE}
t
```

```{r data for active summaries, echo=FALSE, include=FALSE}
